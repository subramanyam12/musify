...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`h-full w-[17vw] overflow-hidden max-sm:z-20 max-sm:h-fit max-sm:w-[50%] max-sm:pb-5 max-sm:pt-12 ${!close && 'max-sm:hidden'
          ...
          <div className="item-center flex w-full flex-col gap-1 capitalize">
            {MENU.map(([Icon, Fill, name], i) => (
              <Link
                ...
                className={`relative flex w-full items-center gap-3 py-2 text-[#afaeae] duration-300 max-sm:cursor-default ${menuitem == name
